...
function BoatProfileDetailInStack({ route }: MoreStackScreenProps<"BoatProfileDetail">) {
    ...
    <ScrollView contentContainerStyle={styles.pageScrollContent}>
      ...
      <Card title="Identity & classification">
        <View style={styles.verticalGap10}>
          {[
            { label: "Boat name", value: identity.boatName, key: "boatName" as const },
...
export default function MoreStack() {
  return (
    ...
    >
      ...
      <Stack.Screen name="BoatProfilesList" component={BoatProfilesListScreen} options={{ title: "Boat profiles" }} />
      <Stack.Screen name="BoatProfileDetail" component={BoatProfileDetailInStack} options={{ title: "Boat asset" }} />
